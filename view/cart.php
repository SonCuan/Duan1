					...
					<table class="table table-cart">
						...
						<tbody>
							<tr class="product-row">
								...
								<td class="text">
									<i style="color: red; font-size:20px;margin-left:50px ; " class="fas fa-trash-alt"></i>
								</td>
								<!-- Chứa thằng hoan -->
							</tr>
								...
								<td colspan="2" class="text-left">
									...
									<form action="#">
										<div class="form-group form-group-sm">
											...
											<input type="text" class="form-control form-control-sm" placeholder=" Tên người nhận">
										...
										<div class="form-group form-group-sm">
											<input type="text" class="form-control form-control-sm" placeholder="Số điện thoại">
										</div><!-- End .form-group -->
